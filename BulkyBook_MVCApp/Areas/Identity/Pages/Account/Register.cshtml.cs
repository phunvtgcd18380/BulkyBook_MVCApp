...
namespace BulkyBook_MVCApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                RoleList = _roleManager.Roles.Where(r => r.Name != SD.Role_User_Indi ).Select(s => s.Name).Select(i => new SelectListItem
                {
                    Text =i,
                    Value = i
                })
